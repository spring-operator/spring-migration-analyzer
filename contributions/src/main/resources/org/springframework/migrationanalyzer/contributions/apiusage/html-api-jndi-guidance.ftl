...
<a href="https://docs.spring.io/spring/docs/3.2.x/spring-framework-reference/html/xsd-config.html#xsd-config-body-schemas-jee" target="_blank">&lt;jee-jndi-lookup&gt; support</a>
